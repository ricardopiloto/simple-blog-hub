...
Os releases são versionados por tag (ex.: `v1.9`, `v1.10`, `v2.0`, `v2.1`, `v2.2`, `v2.3`, `v2.3.1`, `v2.3.2`, `v2.4`, `v2.4.1`, `v2.5`, `v2.5.1`, `v2.5.2`, `v2.5.3`, `v2.6.0`, `v2.6.1`, `v2.6.2`, `v2.6.3`). O histórico de alterações está em **[CHANGELOG](docs/changelog/CHANGELOG.md)**.
...
- **Atualizar o código (local e Docker):** [**ATUALIZAR-SERVIDOR-DOCKER-CADDY**](docs/deploy/ATUALIZAR-SERVIDOR-DOCKER-CADDY.md) — pull, build e execução em desenvolvimento (API, BFF, frontend) e em produção (rebuild contentores, frontend, cópia para document root); scripts de banco de dados manuais quando aplicável. Quem está na **v1.9** e atualiza para **v1.10**: [**ATUALIZAR-1-9-PARA-1-10**](docs/deploy/ATUALIZAR-1-9-PARA-1-10.md). Quem está na **v2.5.3** (ou versão intermédia até **v2.6.2**) e atualiza para **v2.6.3**: [**ATUALIZAR-2-5-3-PARA-2-6-1**](docs/deploy/ATUALIZAR-2-5-3-PARA-2-6-1.md). Referência intermédia **v2.5.2 → v2.6.0**: [**ATUALIZAR-2-5-2-PARA-2-6-0**](docs/deploy/ATUALIZAR-2-5-2-PARA-2-6-0.md).
