...
Os releases são versionados por tag (ex.: `v1.9`, `v1.10`, `v2.0`, `v2.1`, `v2.2`, `v2.3`, `v2.3.1`, `v2.3.2`, `v2.4`). O histórico de alterações está em **[CHANGELOG](docs/changelog/CHANGELOG.md)**.
