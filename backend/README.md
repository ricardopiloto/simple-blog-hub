...
- **api/** — API interna (EF Core + SQLite). Não exposta à internet; ver [api/README.md](api/README.md).
- **bff/** — BFF (Backend-for-Frontend). Único ponto de entrada público; ver [bff/README.md](bff/README.md).

Ordem para rodar: primeiro a API (porta 5001), depois o BFF (porta 5000). O frontend consome apenas o BFF.

Documentação geral: [README](../README.md) · [Funcionalidades e APIs](../docs/FUNCIONALIDADES.md) · [CHANGELOG](../CHANGELOG.md)
