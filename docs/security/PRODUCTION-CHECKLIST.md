...
- [ ] **Dados:** Pasta de dados (ex.: `data/` no host) gravável pelo processo. Os contentores correm como **root**; tipicamente a pasta já é gravável. Ver SECURITY-HARDENING.md.
