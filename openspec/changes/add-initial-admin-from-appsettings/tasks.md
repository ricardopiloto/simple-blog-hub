...
- [ ] 1.3 Garantir que o passo seja executado na inicialização da API (ex.: em `Program.cs`, após `EnsureSeedAsync`, usando `IConfiguration` para ler `Admin:Email` e chamar o novo método de garantia da conta inicial).
