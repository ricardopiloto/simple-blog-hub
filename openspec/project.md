...
- **Runtime / build**: Node.js, Vite 5 (frontend); .NET 9 (backend API e BFF).
...
- **Backend**: .NET 9, Entity Framework Core, SQLite (API); BFF como único ponto de entrada público.
